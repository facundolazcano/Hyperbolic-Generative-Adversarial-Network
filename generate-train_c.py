...
from models.StyleGAN2_train_c import Generator
...
#    torch.cuda.set_device(torch.device(device))
    ...
    kwargs = {'n_mlp': 8,
              ...
              'mode_train_c': args.mode_train_c,
              'lrml_c': args.lrml_c
   }
    ...
    print(g_ema.style)
    print('c:', g_ema.style.c)
    print('lmc:',g_ema.style.lm_c)
    print('real_c:', g_ema.style.get_real_c())
